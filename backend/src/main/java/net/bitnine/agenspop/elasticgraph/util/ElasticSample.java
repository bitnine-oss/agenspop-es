...
public final class ElasticSample {
    ...
    public static List<ElasticVertex> modernVertices(){
        ...
        v1.properties( Arrays.asList(
                ...
                new ElasticProperty(BaseElement.createdTag, "2019-01-21 21:21:21")
        ) );
        ...
        v2.properties( Arrays.asList(
                ...
                new ElasticProperty("country", "USA"),
                new ElasticProperty(BaseElement.createdTag, "2019-03-23 23:23:23")
        ) );
        ...
        v3.properties( Arrays.asList(
                ...
                new ElasticProperty(BaseElement.createdTag, "2019-05-25 15:25:25")
        ) );
        ...
        v4.properties( Arrays.asList(
                ...
                new ElasticProperty("country", "USA"),
                new ElasticProperty(BaseElement.createdTag, "2019-07-27 21:21:21")
        ) );
        ...
        v5.properties( Arrays.asList(
                ...
                new ElasticProperty("lang", "java"),
                new ElasticProperty(BaseElement.createdTag, "2019-09-29 21:21:21")
        ) );
        ...
        v6.properties( Arrays.asList(
                ...
                new ElasticProperty("country", "USA"),
                new ElasticProperty(BaseElement.createdTag, "2019-11-11 21:11:21")
        ) );
    ...
    public static List<ElasticEdge> modernEdges() {
        ...
        e1.properties( Arrays.asList( new ElasticProperty("weight", 0.5d)
                        , new ElasticProperty(BaseElement.createdTag, "2019-02-11 19:11:21")));
        ...
        e2.properties( Arrays.asList( new ElasticProperty("weight", 1.0d)
                        , new ElasticProperty(BaseElement.createdTag, "2019-04-11 19:11:21")));
        ...
        e3.properties( Arrays.asList( new ElasticProperty("weight", 0.4d)
                        , new ElasticProperty(BaseElement.createdTag, "2019-06-11 19:11:21")));
        ...
        e4.properties( Arrays.asList( new ElasticProperty("weight", 1.5d)
                        , new ElasticProperty(BaseElement.createdTag, "2019-08-11 19:11:21")));
        ...
        e5.properties( Arrays.asList( new ElasticProperty("weight", 0.4d)
                        , new ElasticProperty(BaseElement.createdTag, "2019-10-11 19:11:21")));
        ...
        e6.properties( Arrays.asList( new ElasticProperty("weight", 0.2d)
                        , new ElasticProperty(BaseElement.createdTag, "2019-12-11 19:11:21")));
